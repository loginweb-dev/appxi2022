...
@section('javascript')
    ...
    <script>
        ...
        function CalculoHorasRestantes(){
            var city= await axios("setting('admin.url_api')/ciudad/"+1);
            var hora_ci=city.data.horario_noche;
            var today=new Date();
            var hora_inicio =   today.getHours();
            var hora_cierre    = hora_ci;
            var fi=hora_inicio.toString();
            var ff=hora_cierre.toString();
